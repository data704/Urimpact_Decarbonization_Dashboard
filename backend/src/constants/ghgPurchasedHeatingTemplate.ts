...
export const PURCHASED_HEATING_SHEET_NAME = 'Purchased Heating';

export const PURCHASED_HEATING_TEMPLATE_VERSION = '1-workbook';
 ...
 */
export const PURCHASED_HEATING_EXCEL_HEADERS = [
  'Activity Type',
  'Source Type',
  'Consumption',
  'Consumption Unit',
...
export type PurchasedHeatingTemplateFormInput = {
  activityType: string;
  sourceType: string;
  consumption: number;
...
export function mapPurchasedHeatingToGhgBody(
  input: PurchasedHeatingTemplateFormInput,

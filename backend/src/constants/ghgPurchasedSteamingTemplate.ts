...
export const PURCHASED_STEAMING_SHEET_NAME = 'Purchased Steaming';

export const PURCHASED_STEAMING_TEMPLATE_VERSION = '1-workbook';
 ...
 */
export const PURCHASED_STEAMING_EXCEL_HEADERS = [
  'Activity Type',
  'Source Type',
  'Consumption',
  'Consumption Unit',
...
export type PurchasedSteamingTemplateFormInput = {
  activityType: string;
  sourceType: string;
  consumption: number;
...
export function mapPurchasedSteamingToGhgBody(
  input: PurchasedSteamingTemplateFormInput,
